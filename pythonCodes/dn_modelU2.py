...
class SmallModel1(nn.Module):
    def __init__(self):
        ...
        self.lay4=layer(128,256)
        self.lay5=layer(256,256)
        self.lay6=layer(256,256)
        self.lay7=layer(256,128)
        self.lay8=layer(64,64)
        #self.lay9=layer(256,256)
        self.lay10=nn.Conv2d(128,60,3,1,padding=1,bias=False)#layer(128,60)
