...
#        self.lay9=layer(512,1024)
#        self.lay10=layer(1024,1024)
        
        self.lay11=layer(512,512)

#        self.lay16=layer(2048,512)
#        self.lay17=layer(512,512)

        self.lay18=layer(1024,256)
        self.lay19=layer(256,256)

        self.lay20=layer(512,128)
        self.lay21=layer(128,128)
        
        self.lay22=layer(256,64)
        self.lay23=layer(64,64)
        
        self.lay24=layer(128,32)
        self.lay25=layer(32,32)

        self.lay26=nn.Conv2d(32,2,3,1,padding=1,bias=False)
