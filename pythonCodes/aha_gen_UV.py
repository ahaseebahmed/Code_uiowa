...
directory='/Users/Qing/Desktop/NUFFT/'
dtype = torch.float
...
class generator(nn.Module):
    ...
    def __init__(self,siz_latent=100, d=128, out_channel=2):
        ...
        self.deconv3 = nn.ConvTranspose2d(20, 25, 4, 2, 1) # 5x5x256->10x10x128
        self.deconv3_bn = nn.BatchNorm2d(25)
        self.deconv4 = nn.ConvTranspose2d(25, 30, 4, 2, 1) # 10x10x128->20x20x128
    ...
    def forward(self, input):
        ...
        x = F.leaky_relu(self.deconv4_bn(self.deconv4(x)),0)
...
for epoch in range(train_epoch):
    ...
    zi = project_l2_ball(z_.data.numpy())
