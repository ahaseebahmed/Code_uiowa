...
#        self.deconv2 = nn.ConvTranspose2d(d*8,d*4,(4,3),(2,1),(1,1),bias=False)
        ...
        self.deconv2 = nn.ConvTranspose2d(d*16,d*12,(4,3),(2,1),(1,1),bias=False)
        #self.deconv3 = nn.ConvTranspose2d(d*12,d*8,(1,1),(1,1),(0,0),bias=False)
        self.deconv4 = nn.ConvTranspose2d(d*12,d*8,(4,3),(2,1),(1,1),bias=False)
        ...
        self.deconv8 = nn.ConvTranspose2d(d*2,d,(5,3),(1,1),(0,1),bias=False)
