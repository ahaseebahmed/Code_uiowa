...
class generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose2d(10,2048,4,2,1) # 1x1xsiz_latent->3x3x512
        self.deconv1_bn = nn.BatchNorm2d(2048)
        self.deconv11 = nn.ConvTranspose2d(2048,1024,4,2,1) # 1x1xsiz_latent->3x3x512
        self.deconv11_bn = nn.BatchNorm2d(1024)
        self.deconv2 = nn.ConvTranspose2d(1024,512,4,2,1) # 3x3x512->5x5x256
        self.deconv2_bn = nn.BatchNorm2d(512)
        self.deconv3 = nn.ConvTranspose2d(512,256, 4, 2, 1) # 5x5x256->10x10x128
        self.deconv3_bn = nn.BatchNorm2d(256)
        self.deconv4 = nn.ConvTranspose2d(256,60, 4, 2, 1) # 10x10x128->20x20x128
    ...
    def forward(self, input):
        ...
        x = F.leaky_relu(self.deconv11_bn(self.deconv11(x)),0)
