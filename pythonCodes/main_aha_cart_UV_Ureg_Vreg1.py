...
#torch.save(recT,'stm900U.pt')
#del AtA1, maskT1, atbT

#%%
wtsFname1='wts-Uuu'+str(90+1)+'.pt'
G=UnetClass().to(gpu)
...
for ep1 in range(100):
    for bat in range(bb_sz):
        ...
        optimizer.step()
        scheduler.step(loss.detach())
    psnr=sf.myPSNR_dynamic(recT,VT,u1.detach(),v1.detach())
    print(ep1,psnr)
#    if ep1%20==0:
...
#sio.savemat('res200_0.5.mat',{"rec":rec1}) 
