...
class generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose2d(10,10,4,2,1) # 1x1xsiz_latent->3x3x512
        self.deconv1_bn = nn.BatchNorm2d(10)
        self.deconv2 = nn.ConvTranspose2d(10, 120,4,2,1) # 3x3x512->5x5x256
        self.deconv2_bn = nn.BatchNorm2d(120)
        self.deconv3 = nn.ConvTranspose2d(120, 120, 4, 2, 1) # 5x5x256->10x10x128
