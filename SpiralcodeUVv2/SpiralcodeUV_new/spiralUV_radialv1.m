...
% end
for i=1:500;colormap gray;pause(0.05);
    subplot(1,5,1);imagesc(fliplr((abs(y(:,:,i)))));
    subplot(1,5,2);imagesc(fliplr((abs(y1(:,:,i)))));
    subplot(1,5,3);imagesc(fliplr((abs(y2(:,:,i)))));
    subplot(1,5,4);imagesc(fliplr((abs(y3(:,:,i)))));
    subplot(1,5,5);imagesc(fliplr((abs(y4(:,:,i)))));
end
