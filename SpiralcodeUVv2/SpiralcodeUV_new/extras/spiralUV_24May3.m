...
% %lowResRecons=tmp;
% end
% save(strcat('temp_LR',str,'_0.1.mat'),'tmp','L');
...
% 
% 
ktraj_scaled=ktraj_scaled(:,101:500);
kdata=kdata(:,101:500,:);
ktraj_scaled=reshape(ktraj_scaled,[nFreqEncoding*ninterleavesPerFrame,numFramesToKeep]);
kdata=reshape(kdata,[nFreqEncoding*ninterleavesPerFrame,numFramesToKeep,nChannelsToChoose]);
% 
...
%
%clear kdata csm V ;
mkdir './../../Data/Results/res_Dec6';
cd './../../Data/Results/res_Dec6';
save(strcat('res9_',str,'_',num2str(sigma),'_',num2str(lamb(i)),'.mat'), 'y','-v7.3');
