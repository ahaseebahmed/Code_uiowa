...
[~, tmp, L] = est_laplacian_LR2(lowResRecons,FT_LR,kdata_com,csm_lowRes, 4.5, lam(jj));
%lowResRecons=tmp;
end
save('tempp2221.mat','tmp','L');
...
%%
%clear kdata csm V ;
% mkdir './../../Data/Results/res_May30';
% cd './../../Data/Results/res_May30';
% save(strcat('res7_',str,'_',num2str(sigma),'_',num2str(lam(jj)),'.mat'), 'tmp','L','-v7.3');
