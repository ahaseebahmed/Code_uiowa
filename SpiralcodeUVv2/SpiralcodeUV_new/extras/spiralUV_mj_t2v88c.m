...
[~, tmp, L] = est_laplacian_LR(lowResRecons,FT_LR,kdata_com,csm_lowRes, 4.5, 0.3);
...
%%
%clear kdata csm V ;
mkdir './../../Data/Results/res_0.1May11';
cd './../../Data/Results/res_0.1May11';
save(strcat('res_',str,'_',num2str(sigma),'_',num2str(lam(jj)),'.mat'), 'y','lowResRecons','-v7.3');
