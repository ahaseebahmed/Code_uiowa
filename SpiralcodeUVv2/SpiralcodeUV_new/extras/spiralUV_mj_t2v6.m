...
V=V(:,end-nBasis+1:end);
Sbasis=Sbasis(end-nBasis+1:end,end-nBasis+1:end);
save(strcat('w_',str,'_30rApr.mat'),'L');

if (norm(lowResRecons(:)-low_pre(:))<3e-3) 
    break; 
end

end
%save(strcat('W_',str,'.mat'),'L','-v7.3');
%%
...
%%
mkdir './../../Data/Results/res_27Apr';
cd './../../Data/Results/res_27Apr';
save(strcat('res_old_strom',str,'.mat'), 'y','lowResRecons','-v7.3');
