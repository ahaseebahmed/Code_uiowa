...
[kdata_com,ktraj_com] = binSpirals(kdata,ktraj_scaled,1200,9);

tic;lowResRecons = l2Recont2(kdata_com,ktraj_com,coilImages,0.01);toc
[N1,~,~] = size(lowResRecons);
[~,~,L]=estimateLapKernelLR(reshape(lowResRecons,[N1*N1,numFramesToKeep]),2.5,3);
[~,Sbasis,V]=svd(L);
