...
for p=1:size(pt_no,2)
 ...
 str=num2str(pt_no(p));
 load(strcat('/Data/SpiralData/Spiral_cine_3T_1leave_FB_0',str,'_full.mat'),'kdata','ktraj','dcf');
 load(strcat('/Data/SpiralData/cRatioI_0',str,'.mat'));
 kdata=squeeze(kdata);
...
save(strcat('res_10Apr_',str,'.mat'), 'y','lowResRecons','-v7.3');
