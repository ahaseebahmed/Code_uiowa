...
[csm,coilImages] = coil_sens_map_NUFFT(kdata(:,:,1:200,:),ktraj_scaled(:,:,1:200),N,useGPU);
...
%load('vcoilImg_27.mat');
 kdata=reshape(kdata,[nFreqEncoding*ninterleavesPerFrame*numFramesToKeep,nChannelsToChoose]);
 [vkdata,vcoilImages] = combine_coilsv1(kdata,coilImages,0.90);
...
%%
%clear kdata csm V ;
save(strcat('testrecv315',num2str(slc(p)),'.mat'),'y','lowResRecons');
