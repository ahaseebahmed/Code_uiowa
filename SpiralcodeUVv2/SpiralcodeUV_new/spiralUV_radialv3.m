...
[csm1,coilImages] = coil_sens_map_NUFFT(kdata(:,:,1:200,:),ktraj_scaled(:,:,1:200),N,useGPU);
...
[kdata_com,ktraj_com] = binSpirals(kdata,ktraj_scaled,48,19,0);
...
%%
%clear kdata csm V ;
save(strcat('testrecv1',num2str(slc(p)),'.mat'),'y','lowResRecons');
