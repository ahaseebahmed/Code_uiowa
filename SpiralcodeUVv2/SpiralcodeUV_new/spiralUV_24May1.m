...
[~, tmp, L] = est_laplacian_LR1(lowResRecons,FT_LR,kdata_com,csm_lowRes, 4.5, lam(jj));
...
%%
%clear kdata csm V ;
mkdir './../../Data/Results/res_0.1May25';
cd './../../Data/Results/res_0.1May25';
save(strcat('res_',str,'_',num2str(sigma),'_',num2str(lam(jj)),'.mat'), 'tmp','lowResRecons','-v7.3');
