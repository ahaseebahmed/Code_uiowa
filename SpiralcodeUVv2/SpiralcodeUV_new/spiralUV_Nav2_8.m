...
[vkdata,vcoilImages] = combine_coilsv1(kdata,coilImages,0.99);
...
cd(dr1);
save(strcat('datan_se17_',num2str(lambdaSmoothness),'_',num2str(sigma(ii)),'_',num2str(lam(jj)),'_',num2str(sl),'.mat'), 'y','kdata','ktraj_scaled','sense','csm','-v7.3');
cd(dr2);
