...
% % ============================================================== 
 ...
 dr1='./../../Data/SpiralData_UVirginia/Spiral_3T/';
 dr2=pwd;
 cd(dr1);
 load('Spiral_cine_3T_1leave_FB_076_full.mat','kdata','ktraj','dcf');
 cd(dr2);
...
cd(dr1);
save(strcat('res762iter_',num2str(lambdaSmoothness),'_',num2str(sigma),'_',num2str(lam),'.mat'), 'y','-v7.3');
cd(dr2);
