function [K, X, A] = estimateLapKernelLR( nav, sigSq, lambda, nIter)
%function [K, X, A] = estimateLapKernelLR( nav, sigSq, lambda, nIter)
%
% see: Dynamic MRI using SmooThness Regularization on Manifolds (SToRM)
...
%nIter = 70; % put in argument, *** CAC 190306
